...
const Home: React.FC = () => {
    const comingSoonBadge = <Card.Meta><Label><Icon name='gem'/> Coming Soon</Label></Card.Meta>;
    const alphaBadge = <Card.Meta><Label size='small'><Icon name='bug'/> Alpha</Label></Card.Meta>;
    const betaBadge = <Card.Meta><Label size='small'><Icon name='bug'/> Beta</Label></Card.Meta>;
